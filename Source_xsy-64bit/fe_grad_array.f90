SUBROUTINE fe_grad_array(phi,nvdim,gradphi,nedim)
  USE parameters
  USE geometry
  USE constants
  IMPLICIT NONE
...
!  'phi' and is defined at the centroids of the triangular elements.  Note    !
!  that this SUBROUTINE is identical to SUBROUTINE grad, except in the TYPE   !
!  of argument 'gradphi'.                                                     !
!                                                                             !
!  INPUT:                                                                     !
...
!                                                                             !
!  Francisco Simoes, September 2007                                           !
...
! Dummy arguments.
  ...
  TYPE(vector), INTENT(OUT) :: gradphi(nedim)
